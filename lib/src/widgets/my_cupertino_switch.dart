  ...
  Widget build(BuildContext context) {
    ...
    return Opacity(
      ...
      child: _CupertinoSwitchRenderObjectWidget(
        ...
        activeThumbColor: CupertinoDynamicColor.resolve(
            widget.activeThumbColor ?? CupertinoColors.white, context),
...
class _CupertinoSwitchRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    renderObject
      ...
      ..activeColor = activeColor
      ..trackColor = trackColor
      ..thumbColor = value ? activeThumbColor : thumbColor
      ..onChanged = onChanged
      ..textDirection = textDirection;
  }
}

const double _kTrackWidth = 55.0;
...
const double _kSwitchHeight = 20.0;
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  _RenderCupertinoSwitch({
    ...
    required _CupertinoSwitchState state,
        ...
        _thumbPainter = MyCupertinoThumbPainter.switchThumb(
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final double currentThumbExtension =
        MyCupertinoThumbPainter.extension * currentReactionValue;
    final double thumbLeft = lerpDouble(
      trackRect.left + _kTrackInnerStart - MyCupertinoThumbPainter.radius,
      trackRect.left +
          _kTrackInnerEnd -
          MyCupertinoThumbPainter.radius -
